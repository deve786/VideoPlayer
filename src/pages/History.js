...
function History() {
    ...
    return (
        <div className='flex items-center p-5 flex flex-col'>
            <div className='flex justify-around gap-3'>
                <Button variant="gradient" className="flex items-center gap-3 " onClick={sorting}>
                            ...
                            history?.length > 0 ?
                                ...
                                history.map((i, index) => (
                                    <tr key={index} className="even:bg-blue-gray-50/50">
                                        ...
                                        <td className="p-4">
                                            <Typography as="a" href="#" variant="small" color="red" className="font-medium" onClick={() => deleteHistory(i.id)}>
