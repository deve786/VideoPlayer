...
function Home() {
    return (
        <div className='p-8'>
            ...
            <Card className=" justify-around items-center flex flex-row sm:flex-col mt-5 p-5 gap-2 flex-wrap ">

                <div class="relative flex flex-col mt-6 p-3 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
                    <div
